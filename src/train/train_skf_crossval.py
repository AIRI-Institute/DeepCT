...
class TrainEncodeDatasetModel(object):
    ...
    def __init__(
        ...
        self.masked_targets = train_loader.dataset.dataset.cell_wise
        ...
        self._validation_metrics = PerformanceMetrics(
            lambda idx: self.train_loader.dataset.dataset.target_features[idx],
        ...
        val_target_size = self.val_loader.dataset.dataset.target_size
    ...
    def train(self, batch):
        ...
        # ct_mask_idx = np.array_split(range(self.n_cell_types), self.n_folds)
        ...
        if self.masked_targets:
            ...
            target_mask_tr[:, self.ct_mask_idx[self.fold]] = False
            # target_mask_tr[:, self.ct_mask_idx[self.fold][0]: self.ct_mask_idx[self.fold][-1]] = False
    ...
    def _log_embeddings(self, step):
        ...
        cell_type_labels = self.train_loader.dataset.dataset._cell_types
