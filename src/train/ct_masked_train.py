...
class TrainEncodeDatasetModel(object):
    ...
    def run_masked_train(self):
        """
        Start train/val loop, based on cell type validation strategy.
        Use checkpoint_resume config parameter to continue training from a checkpoint.
        """
        ...
        if self.checkpoint_resume is not None:
            ...
            print(f'Start training from {self.checkpoint_epoch} epoch, chunk {self.checkpoint_chunk}')
